...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('chessmatch_player', 'nickname', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True), keep_default=False)

        # Adding field 'Player.avatar_url'
        db.add_column('chessmatch_player', 'avatar_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'Player.twitter_access_token'
        db.add_column('chessmatch_player', 'twitter_access_token', self.gf('django.db.models.fields.CharField')(default='', max_length=1024, blank=True), keep_default=False)

        # Adding field 'Player.twitter_screen_name'
        db.add_column('chessmatch_player', 'twitter_screen_name', self.gf('django.db.models.fields.CharField')(default='', max_length=1024, blank=True), keep_default=False)

        # Adding field 'Player.twitter_profile_image_url'
        db.add_column('chessmatch_player', 'twitter_profile_image_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'Player.twitter_name'
        db.add_column('chessmatch_player', 'twitter_name', self.gf('django.db.models.fields.CharField')(default='', max_length=1024, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Player.nickname'
        db.delete_column('chessmatch_player', 'nickname')

        # Deleting field 'Player.avatar_url'
        db.delete_column('chessmatch_player', 'avatar_url')

        # Deleting field 'Player.twitter_access_token'
        db.delete_column('chessmatch_player', 'twitter_access_token')

        # Deleting field 'Player.twitter_screen_name'
        db.delete_column('chessmatch_player', 'twitter_screen_name')

        # Deleting field 'Player.twitter_profile_image_url'
        db.delete_column('chessmatch_player', 'twitter_profile_image_url')

        # Deleting field 'Player.twitter_name'
        db.delete_column('chessmatch_player', 'twitter_name')
