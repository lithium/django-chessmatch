...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Player.notify_type'
        db.add_column('chessmatch_player', 'notify_type', self.gf('django.db.models.fields.CharField')(default='', max_length=64), keep_default=False)

        # Adding field 'Player.notify_after'
        db.add_column('chessmatch_player', 'notify_after', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Player.notify_type'
        db.delete_column('chessmatch_player', 'notify_type')

        # Deleting field 'Player.notify_after'
        db.delete_column('chessmatch_player', 'notify_after')
    ...
    models = {
        ...
        'chessmatch.player': {
            ...
            'notify_type': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '64'}),
