...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'GameAction.is_check'
        db.delete_column('chessmatch_gameaction', 'is_check')

        # Deleting field 'GameAction.is_mate'
        db.delete_column('chessmatch_gameaction', 'is_mate')


    def backwards(self, orm):
        
        # Adding field 'GameAction.is_check'
        db.add_column('chessmatch_gameaction', 'is_check', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'GameAction.is_mate'
        db.add_column('chessmatch_gameaction', 'is_mate', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
