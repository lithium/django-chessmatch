...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GameAction.flag_count'
        db.add_column('chessmatch_gameaction', 'flag_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GameAction.flag_count'
        db.delete_column('chessmatch_gameaction', 'flag_count')
